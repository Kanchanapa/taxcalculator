...
namespace _2.Pre_ProjectFinal
{
    public partial class main2 : Form
    {
        ...
        // ตั้งค่าเป็นGlobal
        int group1,group2,group3,group4,group5,cost,totalmoney,money,totaltax,sumnogroup4, sumgroup4ver2;
        ...
        private void month_TextChanged(object sender, EventArgs e)
        {
            ...
            ///รวมกลุ่มที่ 1
            group1 = group1 + injure + preg + tempchildbefore61;
            ...
            money = Convert.ToInt32(month.Text) * 12; ///เงินเดือน * 12 
            ...
            totaltax = group1 + group2 + group3 + group5;
            totalmoney = (money - cost - totaltax) - group4;
            if (totalmoney < 0)
            {
                totalmoney = 0;
            }
        ...
        private void taxgroup2(Object sender, EventArgs e)
        {
            ...
            if (dis15per > 500000)
            {
                numericUpDown11.Maximum = 500000;
            }
            else
            {
                numericUpDown11.Maximum = Convert.ToInt32(dis15per);
            }
        ...
        private void taxgroup4(Object sender, EventArgs e)
        {
            group4 = 0;
            ///บริจาคสนับสนุนอื่นๆ
            sumnogroup4 = money - cost - totaltax;
            int supother, doother, doparty = 0;
            int tenpersup = (sumnogroup4 * 10) / 100;
            int sup10pershow = (sumnogroup4 * 10 / 100) / 2;
            if (supportother.Text == "")
            {
                supportother.Text = "0";
            }
            supother = Convert.ToInt32(supportother.Text) * 2;
            ...
            doother = Convert.ToInt32(donateothr.Text);
            sumgroup4ver2 = money - cost - totaltax - supother;
            int sup10perver2 = (sumgroup4ver2 * 10) / 100;
